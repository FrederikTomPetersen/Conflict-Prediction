...
#Henter "blandet" data direkte for postgresdb og 
# Det er derfor nødvendigt at have kørt DataLoad.R filen før det er en succes


#-------------------------------------------------------------------------------
# Udviklingen i antallet af døde relaterede til interne kamphandlinger
...
#------------------------------------------------------------------------------
# Forskellen mellem lande med borgerkrig og lande uden borgerkrig
...
#------------------------------------------------------------------------------
#   Forsøg med index af sammenhæng mellem  politisk landskab og vold Indexing                       
