...
#Funktionen definere om aktørerne er af etnisk elelr relgiøst katakter ved at lede efter udfyldte eth og rel felter i gdelt dataet.
...
#Funktion der opdeler data fra GDELT i forskellige subkategorier. 
# Tager udgangspunkt i Quadclass, der angiver den overordnede begivenhedstype og aktør forholdet.
...
#-------------------------------------------------------------------------------
#           Udregning af rullende gennemsnit for lag af given periode.
# 
