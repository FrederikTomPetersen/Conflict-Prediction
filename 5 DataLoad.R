...
# dette script henter data og gemmer til lokal postgresdatabase og til "Datacave" workspacet.
...
# stykket er afhænigt af, hvor mange bider dataet i postrgressql databasen er delt op i. 
# I det specieale har jeg haft opdelt data i 6 bider, for at "spare" på pladsen i min database i det ugrupperede data.
